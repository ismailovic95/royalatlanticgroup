...
jQuery(".elex-ppct-email-template-input").on('change', function(){
...
jQuery(".elex-rqst-email-preview-close-btn").click(function(){
    ...
    jQuery(".elex-ppct-check-content").hide();
    jQuery(".elex-ppct-check-sec-input").click(function() {
       let is_enabled = jQuery(this).prop('checked');
       jQuery(this).val(is_enabled);
   
        if (jQuery(this).prop('checked')) {
            jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-limit-product").show(300);
            
        } else {
            jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-limit-product").hide(200);
        }
    });
   
    if( jQuery(".elex-ppct-check-sec-input").prop('checked') ){
       jQuery(".elex-ppct-check-content-limit-product").show(300);
        jQuery("#limit_product_is_enabled").prop('checked',true);
        jQuery("#limit_product_is_enabled").val(true)
   
    }else{
        jQuery(".elex-ppct-check-content-limit-product").hide(200);
    ...
    jQuery(".elex-ppct-check-sec-input-exclude-product").click(function() {
       let is_enabled = jQuery(this).prop('checked');
       jQuery(this).val(is_enabled);
       if (jQuery(this).prop('checked')) {
           jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-exclude-product").show(300);
       } else {
           jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-exclude-product").hide(200);
       }
   });
   
   //exclude product
   
   if( jQuery(".elex-ppct-check-sec-input-exclude-product").prop('checked') ){
       jQuery(".elex-ppct-check-content-exclude-product").show(300);
       ...
       jQuery(".elex-ppct-check-content-exclude-product").hide(200);
   ...
   //role based
   if( jQuery(".elex-ppct-check-sec-input-role-based").prop('checked') ){
       jQuery(".elex-ppct-check-content-role-based").show(300);
       ...
       jQuery(".elex-ppct-check-content-role-based").hide(200);
   ...
   jQuery(".elex-ppct-check-sec-input-role-based").click(function() {
       let is_enabled = jQuery(this).prop('checked');
       jQuery(this).val(is_enabled);
   
        if (jQuery(this).prop('checked')) {
            jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-role-based").show(300);
            
        } else {
            jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-role-based").hide(200);
        }
    })
   ...
   jQuery('.elex-ppct-check-sec-input-exclude-product').click(function(){
       if (jQuery(this).prop('checked')) {
           jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-hide-cart").show(300);
           
       } else {
           jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-hide-cart").hide(200);
       }
   });

        
   jQuery('.elex-ppct-check-sec-input-include-product').click(function(){
    if (jQuery(this).prop('checked')) {
        jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-hide-cart-include").show(300);
        
    } else {
        jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-hide-cart-include").hide(200);
    }
});

if( jQuery(".elex-ppct-check-sec-input-exclude-product").prop('checked') ){
    jQuery(".elex-ppct-check-content-hide-cart").show(300);
     jQuery("#hide_add_cart_exclude").prop('checked',true);
     jQuery("#hide_add_cart_exclude").val(true)

 }else{
     jQuery(".elex-ppct-check-content-hide-cart").hide(200);
     jQuery("#hide_add_cart_exclude").prop('checked',false);
     jQuery("#hide_add_cart_exclude").val(false);
 }

 if( jQuery(".elex-ppct-check-sec-input-include-product").prop('checked') ){
    jQuery(".elex-ppct-check-content-hide-cart-include").show(300);
     jQuery("#hide_add_cart_include").prop('checked',true);
     jQuery("#hide_add_cart_include").val(true)

 }else{
     jQuery(".elex-ppct-check-content-hide-cart-include").hide(200);
     jQuery("#hide_add_cart_include").prop('checked',false);
     jQuery("#hide_add_cart_include").val(false);
 }
  

 if( jQuery(".elex-ppct-check-sec-input-sms").prop('checked') ){
    jQuery(".elex-ppct-check-content-sms").show(300);
     jQuery("#is_sms_enabled").prop('checked',true);
     jQuery("#is_sms_enabled").val(true)

 }else{
     jQuery(".elex-ppct-check-content-sms").hide(200);
     jQuery("#is_sms_enabled").prop('checked',false);
     jQuery("#is_sms_enabled").val(false);
 }

 jQuery('.elex-ppct-check-sec-input-sms').click(function(){
    if (jQuery(this).prop('checked')) {
        jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-sms").show(300);
        
    } else {
        jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-sms").hide(200);
    }
});


if( jQuery(".elex-ppct-check-sec-input-chat").prop('checked') ){
    jQuery(".elex-ppct-check-content-chat").show(300);
     jQuery("#is_chat_enabled").prop('checked',true);
     jQuery("#is_chat_enabled").val(true)

 }else{
     jQuery(".elex-ppct-check-content-chat").hide(200);
     jQuery("#is_chat_enabled").prop('checked',false);
     jQuery("#is_chat_enabled").val(false);
 }

 jQuery('.elex-ppct-check-sec-input-chat').click(function(){
    if (jQuery(this).prop('checked')) {
        jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-chat").show(300);
        
    } else {
        jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-chat").hide(200);
    }
});
...
jQuery('.elex-ppct-email-template-input').click(function(){

    if( jQuery(this).prop('checked') ){
         jQuery("#elex-ppct-email-template-input").val(true)
     }else{
         jQuery("#elex-ppct-email-template-input").prop('checked',false);
         jQuery("#elex-ppct-email-template-input").val(false);
     }
    });
    
    if( jQuery('.elex-ppct-email-template-input').prop('checked') ){
        jQuery("#elex-ppct-email-template-input").val(true)
    jQuery(".elex-rqst-quote-email-template-container").show();
    jQuery('.email-body').hide();
...
if( jQuery(".elex-ppct-check-sec-input-widget").prop('checked') ){
    jQuery(".elex-ppct-check-content-widget").show(300);
     jQuery("#show_widget").prop('checked',true);
     jQuery("#show_widget").val(true)

 }else{
     jQuery(".elex-ppct-check-content-widget").hide(200);
 ...
 jQuery('#show_widget').click(function(){
    if (jQuery(this).prop('checked')) {
        jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-widget").show(300);
        
    } else {
        jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-widget").hide(200);
    }
    });
...
jQuery(document).ready(function(){
    if( jQuery(".elex-ppct-widget-button-label-check").prop('checked') ){
...
//add more items
if( jQuery(".elex-ppct-check-sec-input-add-more-items").prop('checked') ){
    jQuery(".elex-ppct-check-content-add-more-items").show(300);
     ...
     jQuery(".elex-ppct-check-content-add-more-items").hide(200);
 ...
 jQuery('#add_more_items').click(function(){
    if (jQuery(this).prop('checked')) {
        jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-add-more-items").show(300);
        
    } else {
        jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-add-more-items").hide(200);
    }
    });
...
jQuery(".elex-ppct-check-sec-input-hidecart-role").click(function() {
    let is_enabled = jQuery(this).prop('checked');
    jQuery(this).val(is_enabled);

     if (jQuery(this).prop('checked')) {
         jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-hidecart").show(300);
         
     } else {
         jQuery(this).parentsUntil(".elex-ppct-check-sec").find(".elex-ppct-check-content-hidecart").hide(200);
     }
 });
 if( jQuery(".elex-ppct-check-sec-input-hidecart-role").prop('checked') ){
    jQuery(".elex-ppct-check-content-hidecart").show(300);
     jQuery("#hide_cart_role").prop('checked',true);
     jQuery("#hide_cart_role").val(true)

 }else{
     jQuery(".elex-ppct-check-content-hidecart").hide(200);
