    ...
    return (
      <>
        <div className="d-flex align-items-center gap-3 ">
          ...
          >
            <span className="pe-auto">Upload Image</span>
          </div>
        </div>
...
export const QuoteForm = (props) => {
  ...
  const handleFormSubmit = async (event) => {
    ...
    var link = elex_ppct_ajax_obj.ajax_url;
    link += "?action=elex_raq_submit_form";
    form.append("ajax_raq_nonce", elex_ppct_ajax_obj.nonce);
    form.append(
      "cart_item",
  ...
  return (
    <div className="shadow w-100 mb-3 rounded-3 bg-white p-3">
      <h5 className="text-center">{props.form.title}</h5>
      <form
        method="post"
