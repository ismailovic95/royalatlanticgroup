<h5 class="my-3 "><b><?php esc_html_e( 'Help & Support', 'elex-product-price-custom-text-and-discount' ); ?></b></h5>
<div class="bg-primary bg-opacity-10 mb-3 elex-ppct-help-support-navbar">
<ul>
<?php 
