 ...
 */
class SenderRegistrator implements \OctolizeShippingCanadaPostVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
     * @var string
     */
    ...
    {
        return new \OctolizeShippingCanadaPostVendor\Octolize\Tracker\SenderToOctolize();
    }
}
