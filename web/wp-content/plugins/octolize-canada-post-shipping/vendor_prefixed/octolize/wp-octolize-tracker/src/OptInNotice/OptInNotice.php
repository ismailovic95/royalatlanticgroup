...
use OctolizeShippingCanadaPostVendor\WPDesk\Notice\PermanentDismissibleNotice;
use OctolizeShippingCanadaPostVendor\WPDesk\PluginBuilder\Plugin\Hookable;
/**
 * Can display Opt In notice.
 */
class OptInNotice implements \OctolizeShippingCanadaPostVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(string $plugin_slug, string $shop_url, \OctolizeShippingCanadaPostVendor\Octolize\Tracker\OptInNotice\ShouldDisplay $should_display)
    {
    ...
    protected function create_notice()
    {
        ...
        new \OctolizeShippingCanadaPostVendor\WPDesk\Notice\PermanentDismissibleNotice($this->prepare_notice_content(), $notice_name, \OctolizeShippingCanadaPostVendor\WPDesk\Notice\Notice::NOTICE_TYPE_SUCCESS);
    }
    /**
     * @return string
     */
