 ...
 * .
 */
class Tracker implements \OctolizeShippingCanadaPostVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
     * @var ViewPageTracker
     */
     ...
     */
    public function __construct(\OctolizeShippingCanadaPostVendor\Octolize\ShippingExtensions\Tracker\ViewPageTracker $view_page_tracker)
    {
    ...
    {
        if ($tracker instanceof \OctolizeShippingCanadaPostVendor\WPDesk_Tracker) {
            $tracker->add_data_provider(new \OctolizeShippingCanadaPostVendor\Octolize\ShippingExtensions\Tracker\DataProvider\ShippingExtensionsDataProvider($this->view_page_tracker));
        }
    }
}
