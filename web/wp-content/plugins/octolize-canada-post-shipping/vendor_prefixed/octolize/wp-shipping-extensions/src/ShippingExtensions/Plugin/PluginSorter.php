...
class PluginSorter
{
    ...
    public function compare(\OctolizeShippingCanadaPostVendor\Octolize\ShippingExtensions\Plugin\Plugin $a, \OctolizeShippingCanadaPostVendor\Octolize\ShippingExtensions\Plugin\Plugin $b) : int
    {
        return $this->get_plugin_priority($a) <=> $this->get_plugin_priority($b);
    }
    private function get_plugin_priority(\OctolizeShippingCanadaPostVendor\Octolize\ShippingExtensions\Plugin\Plugin $plugin)
    {
        $priority = 0;
