 ...
 */
class ServiceInfo extends \OctolizeShippingCanadaPostVendor\CanadaPost\ClientBase
{
    /**
    ...
    {
        $response = $this->get("rs/serviceinfo/shipment?messageType=SO", ['Accept' => 'application/vnd.cpc.serviceinfo-v2+xml'], $options);
        return $response;
    }
}
