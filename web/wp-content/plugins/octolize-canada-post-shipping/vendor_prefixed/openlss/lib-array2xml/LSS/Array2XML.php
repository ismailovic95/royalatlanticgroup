 ...
 */
namespace OctolizeShippingCanadaPostVendor\LSS;

use OctolizeShippingCanadaPostVendor\DomDocument;
use Exception;
/**
...
class Array2XML
{
    ...
    {
        self::$xml = new \OctolizeShippingCanadaPostVendor\DomDocument($version, $encoding);
