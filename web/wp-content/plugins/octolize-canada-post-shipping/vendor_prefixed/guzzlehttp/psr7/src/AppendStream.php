 ...
 * @final
 */
class AppendStream implements \OctolizeShippingCanadaPostVendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\OctolizeShippingCanadaPostVendor\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \OctolizeShippingCanadaPostVendor\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
