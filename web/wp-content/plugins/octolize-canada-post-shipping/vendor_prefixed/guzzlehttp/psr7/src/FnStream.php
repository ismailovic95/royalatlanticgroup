 ...
 * @final
 */
class FnStream implements \OctolizeShippingCanadaPostVendor\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\OctolizeShippingCanadaPostVendor\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
