...
class StreamWrapper
{
     ...
     */
    public static function getResource(\OctolizeShippingCanadaPostVendor\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\OctolizeShippingCanadaPostVendor\Psr\Http\Message\StreamInterface $stream)
    {
