 ...
 */
class SimpleFactory implements \OctolizeShippingCanadaPostVendor\WPDesk\Plugin\Flow\Initialization\InitializationFactory
{
    /** @var bool */
    private $free;
    /**
    ...
    {
        if ($this->free) {
            return new \OctolizeShippingCanadaPostVendor\WPDesk\Plugin\Flow\Initialization\Simple\SimpleFreeStrategy($info);
        }
        return new \OctolizeShippingCanadaPostVendor\WPDesk\Plugin\Flow\Initialization\Simple\SimplePaidStrategy($info);
    }
}
