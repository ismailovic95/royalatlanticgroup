...
namespace OctolizeShippingCanadaPostVendor\WPDesk\Plugin\Flow;

use OctolizeShippingCanadaPostVendor\WPDesk\Plugin\Flow\Initialization\InitializationFactory;
/**
...
{
    const LIBRARY_TEXT_DOMAIN = 'octolize-canada-post-shipping';
     ...
     */
    public function __construct($plugin_version, $plugin_release_timestamp, $plugin_name, $plugin_class_name, $plugin_text_domain, $plugin_dir, $plugin_file, array $requirements, $product_id, \OctolizeShippingCanadaPostVendor\WPDesk\Plugin\Flow\Initialization\InitializationFactory $build_factory, $plugin_shops)
    {
     ...
     */
    private function init_translations(\OctolizeShippingCanadaPostVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \OctolizeShippingCanadaPostVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \OctolizeShippingCanadaPostVendor\WPDesk_Plugin_Info();
