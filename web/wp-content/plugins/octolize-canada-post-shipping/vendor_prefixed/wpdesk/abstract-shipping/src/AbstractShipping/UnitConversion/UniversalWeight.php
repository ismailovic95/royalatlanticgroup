...
class UniversalWeight
{
     ...
     */
    private $weight;
    const UNIT_CALC = [\OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_G => 1, \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_LB => 453.59237, \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_KG => 1000, \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_OZ => 28.34952];
    /**
     * @var int
     */
    private $precision;
    ...
    private function to_grams($weight, $unit)
    {
        ...
        if (\OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_LBS === $unit) {
            $unit = \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_LB;
        }
        if (\OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_G === $unit) {
            return $weight;
        }
        $calc = self::UNIT_CALC[$unit];
        switch ($unit) {
            case \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_KG:
            case \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_LB:
            case \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_OZ:
    ...
    public function as_unit_rounded($target_unit, $precision = 2)
    {
        ...
        switch ($target_unit) {
            case \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_G:
                return $this->weight;
            case \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_KG:
            case \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_LB:
            case \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_OZ:
