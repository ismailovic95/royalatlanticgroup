...
use OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Settings\DefinitionModifier\SettingsDefinitionModifierBefore;
...
abstract class AbstractDecoratorFactory
{
     ...
     */
    public function create_decorator(\OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Settings\SettingsDefinition $settings_definition, $related_field_id, $before = \true, $field_id = null)
    {
    ...
    {
        return $before ? \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Settings\DefinitionModifier\SettingsDefinitionModifierBefore::class : \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Settings\DefinitionModifier\SettingsDefinitionModifierAfter::class;
    }
}
