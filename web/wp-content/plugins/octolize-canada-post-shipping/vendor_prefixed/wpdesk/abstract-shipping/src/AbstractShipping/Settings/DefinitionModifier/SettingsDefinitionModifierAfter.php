 ...
 */
class SettingsDefinitionModifierAfter extends \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Settings\SettingsDefinition
{
    /**
     ...
     */
    public function __construct(\OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Settings\SettingsDefinition $decorated_settings_definition, $field_id_after, $new_field_id, array $new_field)
    {
    ...
    public function get_form_fields()
    {
        ...
        throw new \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Exception\SettingsFieldNotExistsException(\sprintf('Field %1$s not found in settings!', $this->field_id_after));
    }
    /**
     * Validate settings.
     *
