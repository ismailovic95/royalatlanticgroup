...
interface CanTestSettings
{
     ...
     * @return string
     */
    public function check_connection(\OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Settings\SettingsValues $settings, \OctolizeShippingCanadaPostVendor\Psr\Log\LoggerInterface $logger);
    /**
