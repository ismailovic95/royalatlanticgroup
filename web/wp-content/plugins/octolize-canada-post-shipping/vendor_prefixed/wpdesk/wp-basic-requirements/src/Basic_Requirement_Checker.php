...
if (!\interface_exists('OctolizeShippingCanadaPostVendor\\WPDesk_Requirement_Checker')) {
...
if (!\class_exists('OctolizeShippingCanadaPostVendor\\WPDesk_Basic_Requirement_Checker')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker implements \OctolizeShippingCanadaPostVendor\WPDesk_Requirement_Checker
    {
