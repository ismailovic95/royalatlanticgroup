...
?>" style="display:none;">
	<h2><?php 
echo \sprintf(\__('You are deactivating %s plugin.', 'octolize-canada-post-shipping'), $plugin_title);
?></h2>
...
?>">
		<div class="body">
			...
			<div class="panel active" data-panel-id="reasons">
				<h4><strong><?php 
\_e('If you have a moment, please let us know why you are deactivating the plugin (anonymous feedback):', 'octolize-canada-post-shipping');
?></strong></h4>
				<ul class="reasons-list">
					<li class="reason">
						<label>
							...
							<span><?php 
\_e('The plugin suddenly stopped working', 'octolize-canada-post-shipping');
?></span>
						</label>
					</li>
					<li class="reason">
						<label>
							...
							<span><?php 
\_e('The plugin broke my site', 'octolize-canada-post-shipping');
?></span>
						</label>
					</li>
					<li class="reason has-input">
						<label>
							...
							<span><?php 
\_e('I have found a better plugin', 'octolize-canada-post-shipping');
?></span>
						</label>
...
\_e('What\'s the plugin\'s name?', 'octolize-canada-post-shipping');
?>">
						</div>
					</li>
					<li class="reason">
						<label>
						    ...
						    <span><?php 
\_e('I only needed the plugin for a short period', 'octolize-canada-post-shipping');
?></span>
						</label>
					</li>
					<li class="reason">
						<label>
							...
							<span><?php 
\_e('I no longer need the plugin', 'octolize-canada-post-shipping');
?></span>
						</label>
					</li>
					<li class="reason">
						<label>
                            ...
                            <span><?php 
\_e('It\'s a temporary deactivation. I\'m just debugging an issue.', 'octolize-canada-post-shipping');
?></span>
						</label>
					</li>
					<li class="reason has-input">
						<label>
						    ...
						    <span><?php 
\_e('Other', 'octolize-canada-post-shipping');
?></span>
						</label>
						<div class="other" class="reason-input" style="display: none">
							<input type="text" name="other" class="additional-info" placeholder="<?php 
\_e('Please let us know how we can improve our plugin', 'octolize-canada-post-shipping');
?>">
						</div>
					</li>
				</ul>
...
\_e('Cancel', 'octolize-canada-post-shipping');
?></a>
			<a href="#" class="button button-primary button-deactivate allow-deactivate"><?php 
\_e('Skip &amp; Deactivate', 'octolize-canada-post-shipping');
?></a>
		</div>
	</div>
</div><?php 
