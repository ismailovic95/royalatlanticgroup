...
class Factory
{
    ...
    {
        return new \OctolizeShippingCanadaPostVendor\WPDesk\Notice\Notice($noticeContent, $noticeType, $isDismissible, $priority);
    }
    /**
    ...
    {
        return new \OctolizeShippingCanadaPostVendor\WPDesk\Notice\PermanentDismissibleNotice($noticeContent, $noticeName, $noticeType, $priority);
    }
}
