...
namespace OctolizeShippingCanadaPostVendor\WPDesk\Notice;

use OctolizeShippingCanadaPostVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant;
use OctolizeShippingCanadaPostVendor\WPDesk\PluginBuilder\Plugin\PluginAccess;
/**
 * Class AjaxHandler
 *
 ...
 */
class AjaxHandler implements \OctolizeShippingCanadaPostVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant
{
    use PluginAccess;
    ...
    public function processAjaxNoticeDismiss()
    {
        if (isset($_POST[self::POST_FIELD_NOTICE_NAME])) {
            ...
            $option_name = \OctolizeShippingCanadaPostVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_NAME_PREFIX . $noticeName;
            if (\wp_verify_nonce($security, $option_name)) {
                \update_option($option_name, \OctolizeShippingCanadaPostVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_VALUE_DISMISSED);
