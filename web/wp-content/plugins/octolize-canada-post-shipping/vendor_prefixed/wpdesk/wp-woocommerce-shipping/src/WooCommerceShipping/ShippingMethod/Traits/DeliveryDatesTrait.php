...
use OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\EstimatedDelivery\EstimatedDeliveryDatesDisplay;
...
trait DeliveryDatesTrait
{
    ...
    {
        return $shipping_method->get_option(\OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\EstimatedDelivery\EstimatedDeliveryDatesDisplay::DELIVERY_DATES, 'none');
    }
    /**
    ...
    public function should_exclude_rate_with_maximum_transit_time($shipping_method, array $shipping_rate_meta_data)
    {
        ...
        if ('none' !== $this->get_delivery_dates_setting($shipping_method) && '' !== $maximum_transit_time_setting && isset($shipping_rate_meta_data[\OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\EstimatedDelivery\EstimatedDeliveryMetaDataBuilder::BUSINESS_DAYS_IN_TRANSIT])) {
            $maximum_transit_time_setting = \intval($maximum_transit_time_setting);
            $business_days_in_transit = \intval($shipping_rate_meta_data[\OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\EstimatedDelivery\EstimatedDeliveryMetaDataBuilder::BUSINESS_DAYS_IN_TRANSIT]);
