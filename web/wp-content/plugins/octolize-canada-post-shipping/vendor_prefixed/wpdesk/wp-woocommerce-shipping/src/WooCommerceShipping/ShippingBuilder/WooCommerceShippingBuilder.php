...
use OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Client;
...
class WooCommerceShippingBuilder
{
     ...
     */
    public function set_sender_address(\OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\ShippingBuilder\AddressProvider $sender_address)
    {
     ...
     */
    public function set_receiver_address(\OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\ShippingBuilder\AddressProvider $receiver_address)
    {
    ...
    protected function get_woocommerce_dimension_unit()
    {
        switch ($this->dimension_unit) {
            case 'mm':
                return \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Dimensions::DIMENSION_UNIT_MM;
            case 'cm':
                return \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Dimensions::DIMENSION_UNIT_CM;
            case 'm':
                return \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Dimensions::DIMENSION_UNIT_M;
            case 'in':
                return \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Dimensions::DIMENSION_UNIT_IN;
        }
    ...
    protected function get_woocommerce_weight_unit()
    {
        switch ($this->weight_unit) {
            case 'g':
                return \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_G;
            case 'kg':
                return \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_KG;
            case 'lb':
                return \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight::WEIGHT_UNIT_LB;
        }
    ...
    {
        $weight = new \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight();
    ...
    {
        $item = new \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Item();
        ...
        $item->declared_value = new \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Rate\Money();
    ...
    {
        $dimension = new \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Dimensions();
    ...
    {
        $shipping_package = new \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Package();
        $shipping_package->items = [];
        $package_weight = new \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Weight();
    ...
    {
        $shipment = new \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Shipment();
        $ship_from = new \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Client();
        $ship_from->address = $this->sender_address->get_address();
        $ship_to = new \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Client();
