...
class CollectionPointFormatter
{
     ...
     * @return string
     */
    public function get_collection_point_as_label(\OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\CollectionPoints\CollectionPoint $collection_point)
    {
