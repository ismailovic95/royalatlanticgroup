...
use OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shop\ShopSettings;
/**
...
class ShopSettingsMd5HashGenerator
{
     ...
     * @return string
     */
    public function generate_md5_hash(\OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shop\ShopSettings $shop_settings)
    {
