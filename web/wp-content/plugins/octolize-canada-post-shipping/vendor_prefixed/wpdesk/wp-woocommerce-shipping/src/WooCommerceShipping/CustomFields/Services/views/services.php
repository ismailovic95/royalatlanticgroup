...
\esc_html_e('Code', 'octolize-canada-post-shipping');
?></th>
				<th class="service_name"><?php 
\esc_html_e('Name', 'octolize-canada-post-shipping');
?></th>
				<th class="select">
					<label>
						<?php 
\esc_html_e('Enabled', 'octolize-canada-post-shipping');
?>
						<input id="<?php 
echo \esc_attr($params['field_key']);
...
\esc_html_e('Drag and drop the services to control their display order. Confirm by clicking Save changes button below.', 'octolize-canada-post-shipping');
?></span></th>
			</tr>
			</tfoot>
		</table>
