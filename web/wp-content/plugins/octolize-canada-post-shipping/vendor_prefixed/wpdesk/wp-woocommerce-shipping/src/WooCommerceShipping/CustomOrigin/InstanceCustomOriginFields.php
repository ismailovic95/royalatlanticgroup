 ...
 */
class InstanceCustomOriginFields extends \OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\CustomOrigin\CustomOriginFields
{
    ...
    {
        return \__('Origin Settings for this Shipping Method', 'octolize-canada-post-shipping');
    }
    /**
     * @return string
     */
    ...
    {
        return \__('Enable custom origin for this shipping method', 'octolize-canada-post-shipping');
    }
    /**
     * @return string
     */
    ...
    {
        return \__('Use this option to use a different shipper\'s address for this shipping method.', 'octolize-canada-post-shipping');
    }
}
