 ...
 */
class DisplayNoticeLogger implements \OctolizeShippingCanadaPostVendor\Psr\Log\LoggerInterface
{
     ...
     */
    public function __construct(\OctolizeShippingCanadaPostVendor\Psr\Log\LoggerInterface $logger, $service_name, $instance_id)
    {
        $this->logger = $logger;
    ...
    public function log($level, $message, array $context = [])
    {
        ...
        if (\in_array($level, [\OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::DEBUG, \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::INFO], \true)) {
