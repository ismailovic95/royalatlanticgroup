...
trait MetaDataTrait
{
     ...
     */
    public function set_meta_data_builder(\OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\ShippingBuilder\WooCommerceShippingMetaDataBuilder $metadata_builder)
    {
