 ...
 *
 */
class Assets implements \OctolizeShippingCanadaPostVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
     ...
     */
    public function __construct(string $assets_url, string $assets_suffix, ?\OctolizeShippingCanadaPostVendor\WPDesk\ShowDecision\ShouldShowStrategy $should_show_strategy = null)
    {
    ...
    private function get_show_strategy()
    {
        if ($this->should_show_strategy === null) {
            $this->should_show_strategy = new \OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\AssetsShowStrategy();
        }
