...
class PluginShippingDecisions
{
     ...
     *
     */
    public function __construct(\OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\ShippingService $service, \OctolizeShippingCanadaPostVendor\Psr\Log\LoggerInterface $logger)
    {
     ...
     */
    public function set_field_api_status_ajax(\OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\CustomFields\ApiStatus\FieldApiStatusAjax $field_api_status_ajax)
    {
