 ...
 * @package WPDesk\ShippingBuilder\Address
 */
class WooCommerceAddressReceiver implements \OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\ShippingBuilder\AddressProvider
{
    /**
     * Package data.
     *
    ...
    {
        $address = new \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Address();
