 ...
 * @package WPDesk\ShippingBuilder\Address
 */
class CustomOriginAddressSender implements \OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\ShippingBuilder\AddressProvider
{
    /**
     * @var Address;
     */
    ...
    {
        $this->sender_address = new \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Address();
