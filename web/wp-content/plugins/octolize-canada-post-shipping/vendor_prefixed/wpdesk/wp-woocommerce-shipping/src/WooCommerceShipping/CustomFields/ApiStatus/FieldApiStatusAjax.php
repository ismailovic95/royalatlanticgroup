 ...
 */
namespace OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\CustomFields\ApiStatus;
 ...
 */
class FieldApiStatusAjax implements \OctolizeShippingCanadaPostVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
     * Shipping service.
     *
     ...
     */
    public function __construct(\OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\ShippingService $shipping_service, \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Settings\SettingsValues $settings, \OctolizeShippingCanadaPostVendor\Psr\Log\LoggerInterface $logger)
    {
    ...
    public function handle_api_status_ajax_request($return = \false)
    {
        ...
        $json_response = array('connected' => \true, 'status' => \__('OK', 'octolize-canada-post-shipping'), 'class_name' => 'wpdesk_wc_shipping_api_status_ok');
    ...
    {
        if ($this->shipping_service instanceof \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\ShippingServiceCapability\CanTestSettings) {
