...
namespace OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\ShippingMethod\RateMethod\CollectionPoint;
...
use OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\CollectionPoints\CheckoutHandler;
 ...
 */
class CollectionPointRateMethod implements \OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\ShippingMethod\RateMethod\RateMethod
{
     ...
     */
    public function __construct(\OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\ShippingServiceCapability\CanRateToCollectionPoint $service)
    {
     ...
     */
    public static function set_collection_points_checkout_handler(\OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\CollectionPoints\CheckoutHandler $collection_points_checkout_handler)
    {
    ...
    public function handle_rates(\WC_Shipping_Method $method, \OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\ShippingMethod\RateMethod\ErrorLogCatcher $logger, \OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\ShippingBuilder\WooCommerceShippingMetaDataBuilder $metadata_builder, \OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\ShippingBuilder\WooCommerceShippingBuilder $shipment_builder)
    {
        try {
            ...
            if ($rates_count === \count($method->rates)) {
                $logger->info(\__('No rates added from collection point rates!', 'octolize-canada-post-shipping'));
            }
        } catch (\OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Exception\CollectionPointNotFoundException $cpe) {
            $logger->error(\__('Collection point not found.', 'octolize-canada-post-shipping'));
        } catch (\Exception $e) {
     ...
     */
    private function add_rates_to_collection_point(\OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\ShippingMethod $method, \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\ShippingServiceCapability\CanRateToCollectionPoint $service, \OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\ShippingBuilder\WooCommerceShippingMetaDataBuilder $meta_data_builder, \OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\ShippingBuilder\WooCommerceShippingBuilder $shipment_builder)
    {
        ...
        if ($service->is_rate_to_collection_point_enabled($service_settings)) {
            ...
            if (null !== $collection_point) {
                ...
                throw new \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Exception\CollectionPointNotFoundException();
            }
        }
    }
    /**
    ...
    protected function get_collection_point_for_rates(array $package, $method)
    {
        ...
        } catch (\OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Exception\CollectionPointNotFoundException $e) {
     ...
     * @param WooCommerceShippingMetaDataBuilder $meta_data_builder Meta data builder.
     */
    private function add_rates_to_collection_point_from_response(\WC_Shipping_Method $method, \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Shipment\Shipment $shipment, \OctolizeShippingCanadaPostVendor\WPDesk\AbstractShipping\Rate\ShipmentRating $shipment_ratings, $collection_point, \OctolizeShippingCanadaPostVendor\WPDesk\WooCommerceShipping\ShippingBuilder\WooCommerceShippingMetaDataBuilder $meta_data_builder)
    {
