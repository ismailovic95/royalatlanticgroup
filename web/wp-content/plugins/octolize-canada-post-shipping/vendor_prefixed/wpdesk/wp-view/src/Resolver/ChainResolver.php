 ...
 */
class ChainResolver implements \OctolizeShippingCanadaPostVendor\WPDesk\View\Resolver\Resolver
{
    /** @var Resolver[] */
    private $resolvers;
    /**
    ...
    public function resolve($name, \OctolizeShippingCanadaPostVendor\WPDesk\View\Renderer\Renderer $renderer = null)
    {
        foreach ($this->resolvers as $resolver) {
            ...
            } catch (\OctolizeShippingCanadaPostVendor\WPDesk\View\Resolver\Exception\CanNotResolve $e) {
                // not interested
            }
        }
        throw new \OctolizeShippingCanadaPostVendor\WPDesk\View\Resolver\Exception\CanNotResolve("Cannot resolve {$name}");
    }
}
