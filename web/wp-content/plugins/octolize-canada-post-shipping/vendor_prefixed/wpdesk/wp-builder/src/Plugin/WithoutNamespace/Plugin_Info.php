...
if (!\interface_exists('OctolizeShippingCanadaPostVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('OctolizeShippingCanadaPostVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('OctolizeShippingCanadaPostVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \OctolizeShippingCanadaPostVendor\WPDesk_Translatable, \OctolizeShippingCanadaPostVendor\WPDesk_Buildable, \OctolizeShippingCanadaPostVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
