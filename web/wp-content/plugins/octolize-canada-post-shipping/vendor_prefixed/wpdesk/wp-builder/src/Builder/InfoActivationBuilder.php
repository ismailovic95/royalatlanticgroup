...
namespace OctolizeShippingCanadaPostVendor\WPDesk\PluginBuilder\Builder;
...
use OctolizeShippingCanadaPostVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
 ...
 */
class InfoActivationBuilder extends \OctolizeShippingCanadaPostVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
     ...
     */
    public function __construct(\OctolizeShippingCanadaPostVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \OctolizeShippingCanadaPostVendor\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
            $this->plugin->set_active();
        }
        return $this->plugin;
    }
    public function store_plugin(\OctolizeShippingCanadaPostVendor\WPDesk\PluginBuilder\Storage\PluginStorage $storage)
    {
