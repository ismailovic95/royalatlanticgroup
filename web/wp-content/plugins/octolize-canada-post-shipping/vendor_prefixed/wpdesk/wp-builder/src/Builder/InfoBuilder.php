 ...
 */
class InfoBuilder extends \OctolizeShippingCanadaPostVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function __construct(\OctolizeShippingCanadaPostVendor\WPDesk_Buildable $info)
    {
        $this->info = $info;
