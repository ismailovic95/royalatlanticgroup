...
class LegacyBuildDirector
{
    /** @var AbstractBuilder */
    private $builder;
    public function __construct(\OctolizeShippingCanadaPostVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder $builder)
    {
    ...
    public function build_plugin()
    {
        ...
        $storage = new \OctolizeShippingCanadaPostVendor\WPDesk\PluginBuilder\Storage\StorageFactory();
