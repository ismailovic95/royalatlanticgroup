...
class LoggerFacade
{
     ...
     * @return Logger
     */
    public static function getLogger($name = \OctolizeShippingCanadaPostVendor\WPDesk\Logger\WPDeskLoggerFactory::DEFAULT_LOGGER_CHANNEL_NAME)
    {
        if (self::$factory === null) {
            self::$factory = new \OctolizeShippingCanadaPostVendor\WPDesk\Logger\WPDeskLoggerFactory();
        }
     ...
     * @return Logger
     */
    public static function get_logger($name = \OctolizeShippingCanadaPostVendor\WPDesk\Logger\WPDeskLoggerFactory::DEFAULT_LOGGER_CHANNEL_NAME)
    {
     ...
     * @param string $name Name of the logger
     */
    public static function set_disable_log($name = \OctolizeShippingCanadaPostVendor\WPDesk\Logger\WPDeskLoggerFactory::DEFAULT_LOGGER_CHANNEL_NAME)
    {
     ...
     */
    public static function log_wp_error(\WP_Error $e, array $backtrace, array $context = array(), $level = \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::ERROR)
    {
     ...
     * @param string $level Level of error.
     */
    public static function log_exception(\Exception $e, array $context = array(), $level = \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::ERROR)
    {
     ...
     * @param string $level Level of error.
     */
    public static function log_message($message, array $context = array(), $source = null, $level = \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::DEBUG)
    {
     ...
     * @param string $level Level of error.
     */
    public static function log_message_backtrace($message, array $backtrace, array $context = array(), $level = \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::DEBUG)
    {
