...
namespace OctolizeShippingCanadaPostVendor\WPDesk\Logger\WP;
...
class WPCapture
{
    ...
    {
        new \OctolizeShippingCanadaPostVendor\WPDesk\Notice\Notice(\sprintf(
            // Translators: directory.
            \__('Can not enable WP Desk Debug log! Cannot create directory %s or this directory is not writeable!', 'octolize-canada-post-shipping'),
            $dir
        ), \OctolizeShippingCanadaPostVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
     * Add notice for file.
     *
    ...
    private function add_notice_for_file($file)
    {
        new \OctolizeShippingCanadaPostVendor\WPDesk\Notice\Notice(\sprintf(
            // Translators: directory.
            \__('Can not enable WP Desk Debug log! Cannot create file %s!', 'octolize-canada-post-shipping'),
            $file
        ), \OctolizeShippingCanadaPostVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
