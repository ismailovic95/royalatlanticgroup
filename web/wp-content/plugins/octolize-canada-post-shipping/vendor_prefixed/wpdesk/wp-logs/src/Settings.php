...
{
    /** @var string */
    public $level = \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::DEBUG;
    /** @var bool */
     ...
     */
    public function __construct(string $level = \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::DEBUG, bool $use_wc_log = \true, bool $use_wp_log = \true)
    {
        $this->level = $level;
