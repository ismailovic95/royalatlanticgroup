...
namespace OctolizeShippingCanadaPostVendor\WPDesk\Logger\WC;
...
class WooCommerceMonologPlugin implements \WC_Logger_Interface
{
    ...
    public function __construct(\OctolizeShippingCanadaPostVendor\Monolog\Logger $monolog, \WC_Logger_Interface $originalLogger)
    {
    ...
    {
        $this->log(\OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::EMERGENCY, $message, $context);
    }
    ...
    {
        $this->log(\OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::ALERT, $message, $context);
    }
    /**
     * Critical conditions.
     *
    ...
    {
        $this->log(\OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::CRITICAL, $message, $context);
    }
    /**
    ...
    {
        $this->log(\OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::ERROR, $message, $context);
    }
    /**
    ...
    {
        $this->log(\OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::WARNING, $message, $context);
    }
    /**
    ...
    {
        $this->log(\OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::NOTICE, $message, $context);
    }
    /**
     * Interesting events.
     *
    ...
    {
        $this->log(\OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::INFO, $message, $context);
    }
    /**
    ...
    {
        $this->log(\OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::DEBUG, $message, $context);
    }
}
