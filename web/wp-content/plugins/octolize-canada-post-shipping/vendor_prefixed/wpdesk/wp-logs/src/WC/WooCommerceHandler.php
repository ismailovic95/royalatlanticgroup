...
use OctolizeShippingCanadaPostVendor\Monolog\Handler\AbstractProcessingHandler;
use OctolizeShippingCanadaPostVendor\Monolog\Logger;
/**
 * Class WooCommerceFactory
 */
class WooCommerceHandler extends \OctolizeShippingCanadaPostVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return \OctolizeShippingCanadaPostVendor\Monolog\Logger::getLevelName($level);
    }
