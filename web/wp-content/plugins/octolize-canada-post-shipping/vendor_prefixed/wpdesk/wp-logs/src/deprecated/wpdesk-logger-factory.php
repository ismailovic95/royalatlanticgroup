    ...
    class WPDesk_Logger_Factory
    {
        ...
        public static function create_logger()
        {
            if (empty(self::$logger)) {
                $logger = new \OctolizeShippingCanadaPostVendor\WPDesk_Logger();
                $logger->attach_hooks();
                self::$logger = $logger;
            }
            return self::$logger;
        ...
        public static function log_wp_error(\WP_Error $e, array $backtrace = array())
        {
            ...
            self::log_message_backtrace($message, \OctolizeShippingCanadaPostVendor\WPDesk_Logger::ERROR, $backtrace);
        }
        /**
         * Log this exception into WPDesk logger
         *
        ...
        public static function log_exception(\Exception $e)
        {
            ...
            self::log_message($message, $e->getFile(), \OctolizeShippingCanadaPostVendor\WPDesk_Logger::ERROR);
        }
        /**
         ...
         */
        public static function log_message($message, $source = 'unknown', $level = \OctolizeShippingCanadaPostVendor\WPDesk_Logger::DEBUG)
        {
            self::create_logger();
         ...
         * @param array  $backtrace Backtrace information with snapshot of error env.
         */
        public static function log_message_backtrace($message, $level = \OctolizeShippingCanadaPostVendor\WPDesk_Logger::DEBUG, array $backtrace = array())
        {
