...
if (empty($notice_content)) {
    ?>
            <?php 
    \printf(\esc_html__('Hey %s,', 'octolize-canada-post-shipping'), $username);
    ?><br/>
            <?php 
    \esc_html_e('We need your help to improve <strong>WP Desk plugins</strong>, so they are more useful for you and the rest of <strong>30,000+ users</strong>. By collecting data on how you use our plugins, you will help us a lot. We will not collect any sensitive data, so you can feel safe.', 'octolize-canada-post-shipping');
    ?>
            <a href="<?php 
...
\esc_html_e('Allow', 'octolize-canada-post-shipping');
?></button>
    </p>
</div>
