...
if (!\class_exists('OctolizeShippingCanadaPostVendor\\WPDesk_Tracker_Data_Provider_Jetpack')) {
    ...
    class WPDesk_Tracker_Data_Provider_Jetpack implements \WPDesk_Tracker_Data_Provider
    {
        ...
        public function get_data()
        {
            ...
            $data['jetpack_connected'] = \class_exists('OctolizeShippingCanadaPostVendor\\Jetpack') && \is_callable('Jetpack::is_active') && \OctolizeShippingCanadaPostVendor\Jetpack::is_active() ? 'yes' : 'no';
            $data['jetpack_is_staging'] = \class_exists('OctolizeShippingCanadaPostVendor\\Jetpack') && \is_callable('Jetpack::is_staging_site') && \OctolizeShippingCanadaPostVendor\Jetpack::is_staging_site() ? 'yes' : 'no';
