...
if (!\class_exists('OctolizeShippingCanadaPostVendor\\WPDesk_Tracker')) {
    class WPDesk_Tracker implements \WPDesk_Tracker_Interface
    {
        ...
        {
            \add_submenu_page('', 'WP Desk Tracker', 'WP Desk Tracker', 'manage_options', 'wpdesk_tracker', array($this, 'wpdesk_tracker_page'));
            \add_submenu_page('', 'Deactivate plugin', 'Deactivate plugin', 'manage_options', 'wpdesk_tracker_deactivate', array($this, 'wpdesk_tracker_deactivate'));
        }
        ...
        private function send_payload_to_wpdesk(array $payload)
        {
            try {
                ...
                return \true;
            } catch (\OctolizeShippingCanadaPostVendor\WPDesk_Tracker_Sender_Exception_WpError $e) {
                return \false;
            }
        }
        /**
