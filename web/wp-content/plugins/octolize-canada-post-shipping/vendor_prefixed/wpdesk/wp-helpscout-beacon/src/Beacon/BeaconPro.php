 ...
 */
class BeaconPro extends \OctolizeShippingCanadaPostVendor\WPDesk\Beacon\Beacon
{
    /**
     * Beacon constructor.
     *
     ...
     */
    public function __construct($beacon_id, \OctolizeShippingCanadaPostVendor\WPDesk\Beacon\BeaconShouldShowStrategy $strategy, $assets_url, $beacon_search_elements_class = 'hs-beacon-search')
    {
