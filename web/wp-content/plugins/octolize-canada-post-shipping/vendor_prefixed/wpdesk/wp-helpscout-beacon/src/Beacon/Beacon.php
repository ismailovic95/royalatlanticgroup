...
class Beacon
{
     ...
     */
    public function __construct($beacon_id, \OctolizeShippingCanadaPostVendor\WPDesk\Beacon\BeaconShouldShowStrategy $strategy, $assets_url, $beacon_search_elements_class = 'hs-beacon-search', $beacon_image_content = '')
    {
        $this->beacon_id = $beacon_id;
        $this->activation_strategy = $strategy;
        $this->assets_url = $assets_url;
        $this->beacon_search_elements_class = $beacon_search_elements_class;
        $this->confirmation_message = \__('When you click OK we will open our HelpScout beacon where you can find answers to your questions. This beacon will load our help articles and also potentially set cookies.', 'octolize-canada-post-shipping');
    ...
    public function add_beacon_to_footer()
    {
        if ($this->should_display_beacon()) {
            ...
            $confirmation_message = \__('When you click OK we will open our HelpScout beacon where you can find answers to your questions. This beacon will load our help articles and also potentially set cookies.', 'octolize-canada-post-shipping');
