 ...
 */
class PushoverHandler extends \OctolizeShippingCanadaPostVendor\Monolog\Handler\SocketHandler
{
    /** @var string */
    private $token;
     ...
     */
    public function __construct(string $token, $users, ?string $title = null, $level = \OctolizeShippingCanadaPostVendor\Monolog\Logger::CRITICAL, bool $bubble = \true, bool $useSSL = \true, $highPriorityLevel = \OctolizeShippingCanadaPostVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \OctolizeShippingCanadaPostVendor\Monolog\Logger::EMERGENCY, int $retry = 30, int $expire = 25200, bool $persistent = \false, float $timeout = 0.0, float $writingTimeout = 10.0, ?float $connectionTimeout = null, ?int $chunkSize = null)
    {
        ...
        $this->highPriorityLevel = \OctolizeShippingCanadaPostVendor\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \OctolizeShippingCanadaPostVendor\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
    ...
    private function buildContent(array $record) : string
    {
        ...
        $message = \OctolizeShippingCanadaPostVendor\Monolog\Utils::substr($message, 0, $maxMessageLength);
    ...
    {
        $this->highPriorityLevel = \OctolizeShippingCanadaPostVendor\Monolog\Logger::toMonologLevel($value);
        return $this;
    }
    /**
     * @param int|string $value
    ...
    {
        $this->emergencyLevel = \OctolizeShippingCanadaPostVendor\Monolog\Logger::toMonologLevel($value);
        return $this;
    }
    /**
