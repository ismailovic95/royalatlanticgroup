 ...
 */
class ProcessHandler extends \OctolizeShippingCanadaPostVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct(string $command, $level = \OctolizeShippingCanadaPostVendor\Monolog\Logger::DEBUG, bool $bubble = \true, ?string $cwd = null)
    {
        if ($command === '') {
