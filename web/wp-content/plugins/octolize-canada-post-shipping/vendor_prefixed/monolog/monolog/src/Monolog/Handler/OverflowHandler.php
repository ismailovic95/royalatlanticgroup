 ...
 */
class OverflowHandler extends \OctolizeShippingCanadaPostVendor\Monolog\Handler\AbstractHandler implements \OctolizeShippingCanadaPostVendor\Monolog\Handler\FormattableHandlerInterface
{
    /** @var HandlerInterface */
    private $handler;
    /** @var int[] */
    private $thresholdMap = [\OctolizeShippingCanadaPostVendor\Monolog\Logger::DEBUG => 0, \OctolizeShippingCanadaPostVendor\Monolog\Logger::INFO => 0, \OctolizeShippingCanadaPostVendor\Monolog\Logger::NOTICE => 0, \OctolizeShippingCanadaPostVendor\Monolog\Logger::WARNING => 0, \OctolizeShippingCanadaPostVendor\Monolog\Logger::ERROR => 0, \OctolizeShippingCanadaPostVendor\Monolog\Logger::CRITICAL => 0, \OctolizeShippingCanadaPostVendor\Monolog\Logger::ALERT => 0, \OctolizeShippingCanadaPostVendor\Monolog\Logger::EMERGENCY => 0];
    /**
     ...
     */
    public function __construct(\OctolizeShippingCanadaPostVendor\Monolog\Handler\HandlerInterface $handler, array $thresholdMap = [], $level = \OctolizeShippingCanadaPostVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
