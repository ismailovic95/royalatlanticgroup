 ...
 */
class LineFormatter extends \OctolizeShippingCanadaPostVendor\Monolog\Formatter\NormalizerFormatter
{
    ...
    public function format(array $record) : string
    {
        ...
        if (\false !== \strpos($output, '%')) {
            ...
            if (null === $output) {
                ...
                throw new \RuntimeException('Failed to run preg_replace: ' . $pcreErrorCode . ' / ' . \OctolizeShippingCanadaPostVendor\Monolog\Utils::pcreLastErrorMessage($pcreErrorCode));
            }
        }
        return $output;
    }
    ...
    {
        $str = '[object] (' . \OctolizeShippingCanadaPostVendor\Monolog\Utils::getClass($e) . '(code: ' . $e->getCode();
