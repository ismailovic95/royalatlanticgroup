 ...
 */
class IntrospectionProcessor implements \OctolizeShippingCanadaPostVendor\Monolog\Processor\ProcessorInterface
{
    /** @var int */
    private $level;
    /** @var string[] */
     ...
     */
    public function __construct($level = \OctolizeShippingCanadaPostVendor\Monolog\Logger::DEBUG, array $skipClassesPartials = [], int $skipStackFramesCount = 0)
    {
        $this->level = \OctolizeShippingCanadaPostVendor\Monolog\Logger::toMonologLevel($level);
