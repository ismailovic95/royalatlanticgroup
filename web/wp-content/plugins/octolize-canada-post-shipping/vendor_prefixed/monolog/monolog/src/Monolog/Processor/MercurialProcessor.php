 ...
 */
class MercurialProcessor implements \OctolizeShippingCanadaPostVendor\Monolog\Processor\ProcessorInterface
{
    /** @var Level */
    private $level;
     ...
     */
    public function __construct($level = \OctolizeShippingCanadaPostVendor\Monolog\Logger::DEBUG)
    {
