...
class Registry
{
     ...
     * @return void
     */
    public static function addLogger(\OctolizeShippingCanadaPostVendor\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
    ...
    {
        if ($logger instanceof \OctolizeShippingCanadaPostVendor\Monolog\Logger) {
     ...
     */
    public static function getInstance($name) : \OctolizeShippingCanadaPostVendor\Monolog\Logger
    {
