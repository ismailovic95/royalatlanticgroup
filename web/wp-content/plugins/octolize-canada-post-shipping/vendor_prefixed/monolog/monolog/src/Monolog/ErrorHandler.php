 ...
 */
namespace OctolizeShippingCanadaPostVendor\Monolog;
...
class ErrorHandler
{
    ...
    /** @var LogLevel::* */
    private $fatalLevel = \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::ALERT;
    /** @var ?string */
     ...
     * @return ErrorHandler
     */
    public static function register(\OctolizeShippingCanadaPostVendor\Psr\Log\LoggerInterface $logger, $errorLevelMap = [], $exceptionLevelMap = [], $fatalLevel = null) : self
    {
    ...
    public function registerFatalHandler($level = null, int $reservedMemorySize = 20) : self
    {
        ...
        $this->fatalLevel = null === $level ? \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::ALERT : $level;
    ...
    {
        return ['ParseError' => \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::CRITICAL, 'Throwable' => \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::ERROR];
    }
    /**
    ...
    {
        return [\E_ERROR => \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::CRITICAL, \E_WARNING => \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::WARNING, \E_PARSE => \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::ALERT, \E_NOTICE => \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::NOTICE, \E_CORE_ERROR => \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::CRITICAL, \E_CORE_WARNING => \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::WARNING, \E_COMPILE_ERROR => \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::ALERT, \E_COMPILE_WARNING => \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::WARNING, \E_USER_ERROR => \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::ERROR, \E_USER_WARNING => \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::WARNING, \E_USER_NOTICE => \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::NOTICE, \E_STRICT => \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::NOTICE, \E_RECOVERABLE_ERROR => \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::ERROR, \E_DEPRECATED => \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::NOTICE, \E_USER_DEPRECATED => \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::NOTICE];
    }
    /**
    ...
    {
        $level = \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::ERROR;
        ...
        $this->logger->log($level, \sprintf('Uncaught Exception %s: "%s" at %s line %s', \OctolizeShippingCanadaPostVendor\Monolog\Utils::getClass($e), $e->getMessage(), $e->getFile(), $e->getLine()), ['exception' => $e]);
    ...
    public function handleError(int $code, string $message, string $file = '', int $line = 0, ?array $context = []) : bool
    {
        ...
        if (!$this->hasFatalErrorHandler || !\in_array($code, self::$fatalErrors, \true)) {
            $level = $this->errorLevelMap[$code] ?? \OctolizeShippingCanadaPostVendor\Psr\Log\LogLevel::CRITICAL;
    ...
    public function handleFatalError() : void
    {
        ...
        if ($lastError && \in_array($lastError['type'], self::$fatalErrors, \true)) {
            ...
            if ($this->logger instanceof \OctolizeShippingCanadaPostVendor\Monolog\Logger) {
