 ...
 */
namespace OctolizeShippingCanadaPostVendor\Monolog\Handler\Slack;
...
class SlackRecord
{
     ...
     */
    public function __construct(?string $channel = null, ?string $username = null, bool $useAttachment = \true, ?string $userIcon = null, bool $useShortAttachment = \false, bool $includeContextAndExtra = \false, array $excludeFields = array(), \OctolizeShippingCanadaPostVendor\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \OctolizeShippingCanadaPostVendor\Monolog\Formatter\NormalizerFormatter();
        }
    }
    /**
    ...
    {
        switch (\true) {
            case $level >= \OctolizeShippingCanadaPostVendor\Monolog\Logger::ERROR:
                return static::COLOR_DANGER;
            case $level >= \OctolizeShippingCanadaPostVendor\Monolog\Logger::WARNING:
                return static::COLOR_WARNING;
            case $level >= \OctolizeShippingCanadaPostVendor\Monolog\Logger::INFO:
    ...
    public function stringify(array $fields) : string
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \OctolizeShippingCanadaPostVendor\Monolog\Utils::jsonEncode($normalized, \JSON_PRETTY_PRINT | \OctolizeShippingCanadaPostVendor\Monolog\Utils::DEFAULT_JSON_FLAGS) : \OctolizeShippingCanadaPostVendor\Monolog\Utils::jsonEncode($normalized, \OctolizeShippingCanadaPostVendor\Monolog\Utils::DEFAULT_JSON_FLAGS);
    }
    /**
    ...
    public function setFormatter(?\OctolizeShippingCanadaPostVendor\Monolog\Formatter\FormatterInterface $formatter = null) : self
    {
