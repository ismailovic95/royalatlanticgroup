 ...
 */
class TestHandler extends \OctolizeShippingCanadaPostVendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var Record[] */
    protected $records = [];
    ...
    {
        return isset($this->recordsByLevel[\OctolizeShippingCanadaPostVendor\Monolog\Logger::toMonologLevel($level)]);
    }
    /**
