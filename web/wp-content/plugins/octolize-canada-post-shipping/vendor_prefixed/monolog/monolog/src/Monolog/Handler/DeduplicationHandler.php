 ...
 */
class DeduplicationHandler extends \OctolizeShippingCanadaPostVendor\Monolog\Handler\BufferHandler
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(\OctolizeShippingCanadaPostVendor\Monolog\Handler\HandlerInterface $handler, ?string $deduplicationStore = null, $deduplicationLevel = \OctolizeShippingCanadaPostVendor\Monolog\Logger::ERROR, int $time = 60, bool $bubble = \true)
    {
        parent::__construct($handler, 0, \OctolizeShippingCanadaPostVendor\Monolog\Logger::DEBUG, $bubble, \false);
        $this->deduplicationStore = $deduplicationStore === null ? \sys_get_temp_dir() . '/monolog-dedup-' . \substr(\md5(__FILE__), 0, 20) . '.log' : $deduplicationStore;
        $this->deduplicationLevel = \OctolizeShippingCanadaPostVendor\Monolog\Logger::toMonologLevel($deduplicationLevel);
        $this->time = $time;
    }
