 ...
 */
namespace OctolizeShippingCanadaPostVendor\Monolog\Handler\FingersCrossed;
 ...
 */
class ChannelLevelActivationStrategy implements \OctolizeShippingCanadaPostVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface
{
    /**
     * @var Level
     */
    ...
    {
        $this->defaultActionLevel = \OctolizeShippingCanadaPostVendor\Monolog\Logger::toMonologLevel($defaultActionLevel);
