 ...
 */
class NewRelicHandler extends \OctolizeShippingCanadaPostVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($level = \OctolizeShippingCanadaPostVendor\Monolog\Logger::ERROR, bool $bubble = \true, ?string $appName = null, bool $explodeArrays = \false, ?string $transactionName = null)
    {
    ...
    protected function write(array $record) : void
    {
        if (!$this->isNewRelicEnabled()) {
            throw new \OctolizeShippingCanadaPostVendor\Monolog\Handler\MissingExtensionException('The newrelic PHP extension is required to use the NewRelicHandler');
        }
    ...
    protected function setNewRelicParameter(string $key, $value) : void
    {
        if (null === $value || \is_scalar($value)) {
            ...
            \newrelic_add_custom_parameter($key, \OctolizeShippingCanadaPostVendor\Monolog\Utils::jsonEncode($value, null, \true));
        }
    }
    /**
     * {@inheritDoc}
