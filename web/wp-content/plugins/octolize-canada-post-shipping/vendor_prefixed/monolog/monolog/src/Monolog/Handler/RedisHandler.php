 ...
 */
class RedisHandler extends \OctolizeShippingCanadaPostVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($redis, string $key, $level = \OctolizeShippingCanadaPostVendor\Monolog\Logger::DEBUG, bool $bubble = \true, int $capSize = 0)
    {
        if (!($redis instanceof \OctolizeShippingCanadaPostVendor\Predis\Client || $redis instanceof \Redis)) {
