 ...
 */
class NativeMailerHandler extends \OctolizeShippingCanadaPostVendor\Monolog\Handler\MailHandler
{
    /**
     ...
     */
    public function __construct($to, string $subject, string $from, $level = \OctolizeShippingCanadaPostVendor\Monolog\Logger::ERROR, bool $bubble = \true, int $maxColumnWidth = 70)
    {
    ...
    protected function send(string $content, array $records) : void
    {
        ...
        if ($records) {
            $subjectFormatter = new \OctolizeShippingCanadaPostVendor\Monolog\Formatter\LineFormatter($this->subject);
