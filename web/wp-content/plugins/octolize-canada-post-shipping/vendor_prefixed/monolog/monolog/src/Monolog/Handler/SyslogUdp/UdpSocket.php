 ...
 */
namespace OctolizeShippingCanadaPostVendor\Monolog\Handler\SyslogUdp;
...
class UdpSocket
{
    ...
    protected function assembleMessage(string $line, string $header) : string
    {
        ...
        return $header . \OctolizeShippingCanadaPostVendor\Monolog\Utils::substr($line, 0, $chunkSize);
    }
}
