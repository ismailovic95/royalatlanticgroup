 ...
 */
class IFTTTHandler extends \OctolizeShippingCanadaPostVendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var string */
    private $eventName;
    /** @var string */
     ...
     */
    public function __construct(string $eventName, string $secretKey, $level = \OctolizeShippingCanadaPostVendor\Monolog\Logger::ERROR, bool $bubble = \true)
    {
        if (!\extension_loaded('curl')) {
            throw new \OctolizeShippingCanadaPostVendor\Monolog\Handler\MissingExtensionException('The curl extension is needed to use the IFTTTHandler');
        }
