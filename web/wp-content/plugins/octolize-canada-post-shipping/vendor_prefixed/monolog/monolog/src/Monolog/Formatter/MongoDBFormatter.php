 ...
 */
class MongoDBFormatter implements \OctolizeShippingCanadaPostVendor\Monolog\Formatter\FormatterInterface
{
    /** @var bool */
    ...
    protected function formatObject($value, int $nestingLevel)
    {
        ...
        $objectVars['class'] = \OctolizeShippingCanadaPostVendor\Monolog\Utils::getClass($value);
    ...
    {
        $formattedException = ['class' => \OctolizeShippingCanadaPostVendor\Monolog\Utils::getClass($exception), 'message' => $exception->getMessage(), 'code' => (int) $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine()];
