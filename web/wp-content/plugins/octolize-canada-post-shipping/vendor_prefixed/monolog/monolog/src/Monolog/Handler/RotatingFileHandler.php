 ...
 */
class RotatingFileHandler extends \OctolizeShippingCanadaPostVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct(string $filename, int $maxFiles = 0, $level = \OctolizeShippingCanadaPostVendor\Monolog\Logger::DEBUG, bool $bubble = \true, ?int $filePermission = null, bool $useLocking = \false)
    {
        $this->filename = \OctolizeShippingCanadaPostVendor\Monolog\Utils::canonicalizePath($filename);
