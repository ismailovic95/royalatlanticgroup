 ...
 */
class ErrorLogHandler extends \OctolizeShippingCanadaPostVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(int $messageType = self::OPERATING_SYSTEM, $level = \OctolizeShippingCanadaPostVendor\Monolog\Logger::DEBUG, bool $bubble = \true, bool $expandNewlines = \false)
    {
    ...
    {
        return new \OctolizeShippingCanadaPostVendor\Monolog\Formatter\LineFormatter('[%datetime%] %channel%.%level_name%: %message% %context% %extra%');
    }
    /**
     * {@inheritDoc}
     */
    protected function write(array $record) : void
    {
        ...
        if ($lines === \false) {
            ...
            throw new \RuntimeException('Failed to preg_split formatted string: ' . $pcreErrorCode . ' / ' . \OctolizeShippingCanadaPostVendor\Monolog\Utils::pcreLastErrorMessage($pcreErrorCode));
        }
