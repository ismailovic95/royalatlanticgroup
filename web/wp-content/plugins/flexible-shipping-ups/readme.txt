...
Tags: woocommerce ups, ups, ups woocommerce, ups shipping, ups api, shipping rates, ups calculator, flexible shipping, woocommerce shipping, UPS Access Points,live rates
...
UPS WooCommerce plugin lets you offer a full range of UPS shipping options. Provide your customers with the automatically calculated shipping rates for numerous UPS services and let them choose their preferred Access Points.
...
View the dedicated [Flexible Shipping UPS WooCommerce documentation](https://octol.io/ups-repo-docs)
...
Yes. UPS WooCommerce plugin uses your account to make a connection to the UPS API. You can check the API Status in the settings section. Sign up with UPS quickly and easily [on their site](https://www.ups.com/doapp/SignUp).
...
1. UPS general settings
2. Adding a new UPS Live Rates shipping method
3. UPS Live Rates shipping methods added within a shipping zone
4. UPS Live Rates shipping method configuration screen
5. UPS Live Rates custom services' settings
6. UPS SurePost Live Rates custom services' settings
